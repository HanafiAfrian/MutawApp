...
export default class CariMutawifah extends Component {
    ...
    this.url = "https://mutawif.co.id/api/muapi/mitra_ziarah_trcc.php";
  }
  	componentDidMount(){
      this.ambilListData()
  }
 ...
 color: 'gray',
           ...
           <Text
            ...
            <View
              ...
              <TouchableOpacity
                onPress={() => this.props.navigation.navigate('DetailBayarbri', {	
