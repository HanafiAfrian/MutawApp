...
export default class TotalTagihan extends Component {
    ...
    tampil: false,
		...
		this.url = "https://mutawif.co.id/api/muapi/hospital.php";
...
"&longitude="+longitude+
          ...
          .then((response)=>response.json())
          .then((json)=>{
			 this.props.navigation.navigate('CariMitraHospital', {	
...
"&longitude="+longitude+
          ...
          .then((json)=>{
			   ...
			   this.props.navigation.navigate('CariMitraHospitalBri', {	
...
"&longitude="+longitude+
          ...
          .then((json)=>{
			   ...
			   this.props.navigation.navigate('CariMitraHospitalCod', {	
...
totalreal : totalreal,
		...
		var totalrupiah =	this.props.route.params.totalrupiah; 
		 ...
		 var metode_pembayaran = 'CREDIT CARD';
          ...
          .then((response)=>response.json())
          .then((json)=>{
			   this.props.navigation.navigate('CariMitraCc', {
metode : 'Credit Card',					
jumlah_order : jumlah_order,   
			totalreal : totalreal,
			 totalrupiah : totalrupiah});
...
var longitude =	this.props.route.params.longitude
	  var telepon =	this.props.route.params.telepon; 
		...
		var jenis =	this.props.route.params.jenis; 
			...
			var nama_obat =	this.props.route.params.nama_obat; 
		var gejala =	this.props.route.params.gejala; 
 ...
 <View style={styles.mainbank}>
            <View style={styles.bank}>
              ...
              <View>
                <Image source={BriIcon} style={{width: 70, height: 20, color: 'gray'}} />
              </View>
            </View>
            {/* header */}
            <View style={{display: 'flex', flexDirection: 'row'}}>
