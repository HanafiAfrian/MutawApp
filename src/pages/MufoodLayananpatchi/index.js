...
import {patchi, IconBack, IconNasibox} from '../../assets';

export default class MufoodLayananpatchi extends Component {
 constructor(props) {
    super(props);
    this.state = {
  ...
  this.url = "https://mutawif.co.id/api/muapi/muufood_patchi.php";
    }
  ...
  render() {
    ...
    return (
      <ScrollView style={{flex: 1, backgroundColor: '#222a32'}}>
        ...
        <View>
          <Image style={styles.imgads} source={patchi} />
        </View>
          ...
          <View
            ...
            <View>
              <Text
                ...
                Diamantine Milk Chocolate Bar  
<Text style={{color: 'orange'}}> With Almonds 50GRS </Text>
              </Text>
          ...
          <View style={{
            ...
            <Text style={{color: 'white'}}>Coklat kualitas premium Terbuat dari bahan-bahan
terbaik, bubuk kakao murni, dan tanpa sedikit pun
pewarna atau pengawet</Text>
        ...
        <TouchableOpacity
          ...
          onPress={() => this.props.navigation.navigate('MufoodOrder',{resto:'Restoran Patchi', harga:this.state.harga,telepon:telepon, nama_lengkap:nama_lengkap, email_pribadi: email_pribadi,  hargarupiah:this.state.hargarupiah })}>
