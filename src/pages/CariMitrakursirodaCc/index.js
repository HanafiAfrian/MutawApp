...
export default class CariMitraCc extends Component {
    ...
    this.url = "https://mutawif.co.id/api/muapi/mitra_kursiroda_trcc.php";
  }
      ...
      <ScrollView style={{backgroundColor: '#eaeaea'}}>
        <View>
          ...
          <View
            ...
            />
            <Text style={{marginLeft: 10, fontSize: 12 ,  color : 'gray',}}>  {metode} / {jumlah_order}
 ...
 color: 'gray',
            ...
            <View
              ...
              <Text
				...
				{totalreal} SR  / {totalrupiah} Rupiah
              </Text>
            </View>
