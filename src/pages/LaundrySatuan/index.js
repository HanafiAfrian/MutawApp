...
const rupiah = 'Rp. ' + convert.join('.').split('').reverse().join('')
            ...
            <View
              ...
              <View>
                ...
                <Text
                  ...
                  <Text style={{color: 'orange'}}>Laundry Satuan </Text>
                </Text>
              </View>
              <View>
 ...
 value = {this.state.jumlah_order}
    ...
    <View>
      ...
      <Text style={{marginLeft: 20, color: 'red'}}>{this.state.jumlah_order} PCS</Text>
    </View>
    <View
      style={{
        borderBottomWidth: 1,
        ...
        marginLeft: 20,
                    ...
                    <View
                      ...
                      <TouchableOpacity
                        ...
                        onPress={() =>
                          this.props.navigation.navigate('TotalTagihanlaundrysatuan', {
