...
componentDidMount(){
  ...
  render() {
        ...
        <View style={{flex: 1, backgroundColor: 'white'}}>
          ...
          <View>
            ...
            <View
              ...
              <View style={{width: '50%'}}>
                <TouchableOpacity style={styles.roundButtonkeberangkatan} onPress={() =>  this.props.navigation.navigate('AirportOrder')}>
                  <Text style={{color: '#0d7883'}}>Kedatangan</Text>
                </TouchableOpacity>
              </View>
              <View style={{width: '50%'}}>
                <TouchableOpacity style={styles.roundButton} onPress={() =>  this.props.navigation.navigate('AirportOrderkeberangkatan')}>
    ...
    <View>
      ...
      <Text style={{marginLeft: 20, color: 'red'}}>{(totalbayar)} SR ( {(totalrupiah)})</Text>
    </View>
    <View
      style={{
        borderBottomWidth: 1,
