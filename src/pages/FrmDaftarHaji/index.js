  ...
  klikSimpan() {
     if (
      ...
      if (this.state.idEdit) {
        ...
        var urlAksi = this.url + '/?op=daftarhaji';
   var str = '1 2 3 4 5 6 7 8 9 0';
    ...
    var res = every_word_im_shuffling.substring(0, 4);
       ...
       var pwsatu = this.state.pwsatu;
	      var kategori = 'Kloter';
		 var kloter =  this.state.nokloter;
		   var token = this.state.idToken;
		  var lokasi =  this.state.selectedcat;
      }
      ...
      fetch(urlAksi, {
        ...
        .then(responseJson => {
          ...
          this.props.navigation.replace('OtpHaji', {
            itemId: res,
            telepon: nohp,
            nama_lengkap: email,
        ...
        <View style={{backgroundColor: 'white', flex: 1, }}>
          {/* tengah */}
            <View style={styles.welcomebg} >
              <TouchableOpacity
                ...
                onPress={() => this.props.navigation.navigate('DaftarHaji')}>
                <Image source={IconBack} />
              </TouchableOpacity>
              <Text style={styles.welcome}  onPress={() => this.props.navigation.navigate('DaftarHaji')}>Pendaftaran 
			  Kloter</Text>
          ...
          <View style={styles.container}>
            <View style={styles.textinputmain}>
                    ...
                    <Text style={{color:'grey',marginTop:10}}>Pilih Embarkasi</Text>
    <View style={{borderColor:'grey',
borderWidth:1,borderRadius:5}}>   
			  
         <Picker
                mode="dropdown"
            style={{backgroundColor:"#eaeaea",marginBottom:10,...styles.pickStyle}}
         ...
         <TextInput
                ...
                value={this.state.nokloter}
                onChangeText={text => this.setState({nokloter: text})}
              />
		   ...
		   <View>
              ...
              <TextInput
			   autoFocus
                style={styles.input}
                placeholder="Nama Ketua Kloter (Username)"
				 placeholderTextColor="gray"
            ...
            <View style={styles.checkboxInput}>
              ...
              <Text style={styles.label}>
                ...
                <Text
                  ...
                  menyetujui syarat dan ketentuan mutawif</Text> <Text></Text> dengan mencentang pada cek box yang tersedia, Kemudian Klik 
