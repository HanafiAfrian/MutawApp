...
import {BannerMassage} from '../../assets';
  ...
  render() {
    ...
    return (
      <ScrollView style={{flex: 1, backgroundColor: '#222a32'}}>
        ...
        <View>
          <Image style={styles.imgads} source={BannerMassage} />
        </View>
        ...
        <View
          ...
          <View>
            <View>
              ...
              <Text style={{color: 'white', fontSize: 12, textAlign: 'center'}}>
               {this.state.textreal} SR/Jam (Rp. {this.state.textrp})
              </Text>
            </View>
          </View>
            ...
            <View style={{display: 'flex', flexDirection: 'row'}}>
              ...
              <View>
                <Text style={{color: 'white', textAlign: 'justify'}}>
                  Menyediakan jasa pijat untuk para Jemaah
                </Text>
              </View>
            </View>
            <View style={{display: 'flex', flexDirection: 'row'}}>
          ...
          <View style={{display: 'flex', flexDirection: 'row'}}>
            ...
            <Text style={{color: 'white'}}>
              Harga hanya untuk 1 orang selama 1 jam
            </Text>
          </View>
          <View style={{display: 'flex', flexDirection: 'row'}}>
            <Text style={{color: 'white'}}>2. </Text>
            <Text style={{color: 'white'}}>Jasa bebas sesuai request</Text>
          </View>
          <View style={{display: 'flex', flexDirection: 'row'}}>
            <Text style={{color: 'white'}}>3. </Text>
            <Text style={{color: 'white'}}>
              Dilarang keras memesan petugas pijat yang berlawanan jenis
            </Text>
          </View>
        </View>
        ...
        <TouchableOpacity
          ...
          onPress={() => this.props.navigation.navigate('MassageOrder', {telepon:telepon, nama_lengkap:nama_lengkap, email_pribadi: email_pribadi , latitude:this.state.userLocation.coords.latitude,longitude:this.state.userLocation.coords.longitude ,hargarupiah:this.state.hargarupiah})}>
