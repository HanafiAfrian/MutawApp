...
"&longitude="+longitude+
          ...
          .then((response)=>response.json())
          .then((json)=>{
			 this.props.navigation.navigate('CariMitraMessagepr', {	
...
"&longitude="+longitude+
          ...
          .then((json)=>{
			   ...
			   this.props.navigation.navigate('CariMitraMessageprBri', {	
...
"&longitude="+longitude+
          ...
          .then((json)=>{
			   ...
			   this.props.navigation.navigate('CariMitraMessageprCod', {	
