...
import {BannerMutawifah} from '../../assets';
...
export default class Ricebox extends Component {
 constructor(props) {
  ...
  this.url = "https://mutawif.co.id/api/muapi/mutawifah.php";
    }
componentDidMount()  {
  ...
  render() {
    ...
    return (
      <ScrollView style={{flex: 1, backgroundColor: '#222a32'}}>
        ...
        <View>
          <Image style={styles.imgads} source={BannerMutawifah} />
        </View>
        ...
        <View
          ...
          <View>
            <View>
              <Text
                ...
                Harga<Text style={{color: 'orange'}}> Mutawifah</Text>
              </Text>
		   ...
		   <View style={{display: 'flex', flexDirection: 'row'}}>
              ...
              <View>
                <Text style={{color: 'white', textAlign: 'justify'}}>
                   Mutawifah merupakan Warga Negara Indonesia.
                </Text>
              </View>
            </View>
            ...
            <View style={{display: 'flex', flexDirection: 'row'}}>
              ...
              <View>
                <Text style={{color: 'white', textAlign: 'justify'}}>
                  Hanya menyediakan mutawifah yang professional dan
                  berpengalaman.
                </Text>
              </View>
            </View>
            <View style={{display: 'flex', flexDirection: 'row'}}>
              ...
              <View>
                <Text style={{color: 'white'}}>
                  Menyediakan mutawifah untuk membantu, menuntun, dan membawa
                  Jemaah wanita untuk ziarah dan sholat ke raudhah serta ke
                  makam rasul
                </Text>
              </View>
            </View>
          ...
          <View style={{display: 'flex', flexDirection: 'row'}}>
            ...
            <Text style={{color: 'white'}}>
              Harga hanya untuk 1 orang mutawifah/ untuk 1 group dalam 1 kali
              keberangkatan
            </Text>
          </View>
        </View>
        ...
        <TouchableOpacity
          ...
          onPress={() => this.props.navigation.navigate('MutawifahOrder', {telepon:telepon, nama_lengkap:nama_lengkap, email_pribadi: email_pribadi, latitude:this.state.userLocation.coords.latitude,longitude:this.state.userLocation.coords.longitude,hargarupiah:this.state.hargarupiah  })}>
