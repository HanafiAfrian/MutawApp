...
import {IconMassage} from '../../assets';

export default class MassageOrder extends Component {
 constructor(props) {
    super(props);
...
rupiahharga :'',
   ...
   this.url = "https://mutawif.co.id/api/muapi/massage.php";
  }
  componentDidMount(){
      this.ambilListData()
  }
...
const rupiah = 'Rp. ' + convert.join('.').split('').reverse().join('')
	console.log(rupiah) 
	    if
	  (this.state.lk == true  && this.state.pr == false )
	  {
...
this.setState({show: true})
	  ...
	  (this.state.lk == false  && this.state.pr == true )
	  {
...
const rupiah = 'Rp. ' + convert.join('.').split('').reverse().join('')
        ...
        <View style={{flex: 1, backgroundColor: 'white'}}>
          <View style={{flex: 1, backgroundColor: '#222a32'}}>
            <View
              ...
              <View>
                <TouchableOpacity
                       onPress={() => this.props.navigation.navigate('Massage',{telepon:telepon, nama_lengkap:nama_lengkap, email_pribadi:email_pribadi,hargarupiah:hargarupiah } )}>
              ...
              <View>
                <Image source={IconMassage} style={{alignSelf: 'center'}} />
                <Text
          ...
          <View style={styles.container}>
            ...
            <View style={styles.searchSection}>
              ...
              <View>
                <View>
                  <Text style={styles.subformtext}>Waktu Pertemuan</Text>
                </View>
                <View style={styles.subform}>
                <Icon
 ...
 value = {this.state.jumlah_order}
            ...
            <Text style={{fontWeight: 'bold', marginLeft: 20, color:'gray'}}>
              Pilih Petugas :
            </Text>
            <View
              style={{
              ...
              <View style={{display: 'flex', flexDirection: 'row'}}>
                ...
                />
                <Text style={{marginTop: 2, marginLeft: 2, color:'black'}}>Laki-Laki</Text>
              </View>
              <View
                style={{
                  display: 'flex',
                ...
                />
                <Text style={{marginTop: 2, marginLeft: 2, color:'black'}}>Perempuan</Text>
              </View>
            </View>
          </View>
        ...
        marginLeft: 20,
                    ...
                    <View
                      ...
                      <TouchableOpacity
                        ...
                        onPress={() =>
                          this.props.navigation.navigate('TotalTagihanmassage', {
					latitude :latitude,
longitude :longitude,
        ...
        marginLeft: 20,
                    ...
                    <View
                      ...
                      <TouchableOpacity
                        ...
                        onPress={() =>
                          this.props.navigation.navigate('TotalTagihanmassagepr', {
