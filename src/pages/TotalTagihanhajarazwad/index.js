...
"&longitude="+longitude+
          ...
          .then((response)=>response.json())
          .then((json)=>{
			 this.props.navigation.navigate('CariMitraHajarAswad', {	
...
"&longitude="+longitude+
          ...
          .then((json)=>{
			   ...
			   this.props.navigation.navigate('CariMitraHajarAswadBri', {	
...
"&longitude="+longitude+
          ...
          .then((json)=>{
			   ...
			   this.props.navigation.navigate('CariMitraHajarAswadCod', {	
