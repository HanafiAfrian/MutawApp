...
export default class TotalTagihanairportkeberangkatan extends Component {
	  ...
	  (this.state.bni == true  && this.state.bri == false && this.state.cod == false && this.state.cc == false  )
	  {
        ...
        alert('Silakan masukkan Waktu Pesan Dan Identitas Mutawif');
          ...
          if(this.state.idEdit){
            ...
            var urlAksi = this.url+"/?op=pesankeberangkatan";
		...
		var jenis_muassasah = this.props.route.params.jenis_muassasah; 
		 var metode_pembayaran = 'BNI VIRTUAL ACCOUNT';
          ...
          fetch(urlAksi,{
              ...
              body:
					...
					"&jenis_muassasah="+jenis_muassasah+
		...
		var jenis_muassasah = this.props.route.params.jenis_muassasah; 
		 var metode_pembayaran = 'BRI VIRTUAL ACCOUNT';
          ...
          .then((json)=>{
			   ...
			   this.props.navigation.navigate('DetailBayarbri', {	
      ...
      <ScrollView style={{flex: 1, backgroundColor: 'white'}}>
        <View style={styles.welcomebg}>
          <TouchableOpacity
            ...
            onPress={() => this.props.navigation.navigate('AirportKeberangkatan',{telepon:telepon, nama_lengkap:nama_lengkap, email_pribadi:email_pribadi,hargarupiah:totalrupiah })}>
            <Icon
              name="chevron-left"
              size={20}
              color="#fff"
        ...
        <View style={{flex: 1}}>
          ...
          <View>
            <Text style={{fontWeight: 'bold', marginLeft: 15, marginTop: 15, color:'gray'}}>
