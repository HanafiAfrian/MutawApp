...
import {IconHajaswad, IconBack, IconNasibox} from '../../assets';
        ...
        <View style={{flex: 1, backgroundColor: 'white'}}>
          <View style={{flex: 1, backgroundColor: '#222a32'}}>
            <View
              ...
              <View>
                <TouchableOpacity
                        onPress={() => this.props.navigation.navigate('Hajaraswad',{telepon:telepon, nama_lengkap:nama_lengkap, email_pribadi:email_pribadi } )}>
              ...
              <View>
                <Image source={IconHajaswad} style={{alignSelf: 'center'}} />
                <Text
                  style={{color: 'white', fontSize: 22, fontWeight: 'bold'}}>
                  Hajr Aswad & Hijr Ismail 
        ...
        marginRight: 20,
                    ...
                    <View
                      ...
                      <TouchableOpacity
                        ...
                        onPress={() =>
                          this.props.navigation.navigate('TotalTagihanhajarazwad', {
						latitude :latitude,
longitude :longitude,	  
			telepon : telepon,
