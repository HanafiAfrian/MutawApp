        ...
        <View style={{flex: 1, backgroundColor: 'white'}}>
          <View style={{flex: 1, backgroundColor: '#222a32'}}>
            <View
              ...
              <View>
                <TouchableOpacity
                      onPress={() => this.props.navigation.navigate('Taxi',{telepon:telepon, nama_lengkap:nama_lengkap, email_pribadi:email_pribadi,hargarupiah:hargarupiah } )}>
              ...
              <View>
                ...
                <Text
                  ...
                  Mu- 
                  <Text style={{color: '#c19737'}}>Car</Text>
                </Text>
              </View>
              <View>
          ...
          <View style={styles.container}>
            ...
            <View style={styles.searchSection}>
              ...
              <View>
                <View>
                  <Text style={styles.subformtext}>Lokasi Tujuan</Text>
                </View>
                <View style={styles.subform}>
                  <Icon
                    style={styles.searchIcon}
                  ...
                  placeholder="Lokasi Tujuan"
					 placeholderTextColor="gray"
                  value = { this.state.tempat_tujuan }
                    onChangeText = {(text) => this.setState({tempat_tujuan: text })}
                    underlineColorAndroid="transparent"
                  />
                </View>
              </View>
            ...
            <View style={styles.searchSection}>
              <View>
                <View>
                  <Text style={styles.subformtext}>Jumlah Penumpang (Org)</Text>
                </View>
                <View style={styles.subform}>
                  <Icon
                    style={styles.searchIcon}
        ...
        marginLeft: 20,
                    ...
                    <View
                      ...
                      <TouchableOpacity
                        ...
                        onPress={() =>
                          this.props.navigation.navigate('TotalTagihanmucar', {
				latitude :latitude,
longitude :longitude,			  
			telepon : telepon,
...
email_pribadi : email_pribadi,			
			pilih_tanggal_pesan: pilih_tanggal_pesan,
			  ...
			  tempat_tujuan: this.state.tempat_tujuan, 	
