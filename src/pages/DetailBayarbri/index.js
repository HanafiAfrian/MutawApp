...
export default class DetailBayarbri extends Component {
  ...
  constructor(props) {
    ...
    this.url = "https://mutawif.co.id/api/muapi/pembayaranbri.php";
  }
  componentDidMount() {
    this.ambilListData()
  }
              ...
              <View style={styles.mainbank}>
                ...
                <View>
                  ...
                  <View style={{ flexDirection: 'row', justifyContent: "space-between" }}>
                    <Text style={{ fontSize: 16, color: 'black', marginBottom: 10, fontFamily: 'poppins-medium', marginTop: 15 }}>Nomor BRI Virtual Account</Text>
                    <Image source={BriIcon} style={{ width: 60, height: 55 }} />
                  </View>
