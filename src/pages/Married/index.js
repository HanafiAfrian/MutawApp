...
import {BannerMarried} from '../../assets';
...
constructor(props) {
   ...
   this.url = "https://mutawif.co.id/api/muapi/meried.php";
  }
componentDidMount()  {
  ...
  render() {
    ...
    return (
      <ScrollView style={{flex: 1, backgroundColor: '#222a32'}}>
        ...
        <View>
          <Image style={styles.imgads} source={BannerMarried} />
        </View>
        ...
        <View
            ...
            <View style={{display: 'flex', flexDirection: 'row'}}>
              ...
              <View>
                <Text style={{color: 'white', textAlign: 'justify'}}>
                  Menyediakan jasa untuk Mengurus segala urusan dan surat surat
                  yang diperlukan untuk menyelenggarakan pernikahan di masjidil
                  haram , termasuk tuan kadi, surat resmi pernikahan, buku
                  nikah, saksi, surat izin menyelenggarakan pernikahan , dll)
                </Text>
              </View>
            </View>
          </View>
          ...
          <View style={{display: 'flex', flexDirection: 'row'}}>
            ...
            <Text style={{color: 'white'}}>
              Tidak include mempersiapkan acara( dekorasi, makanan,dll)
            </Text>
          </View>
        </View>
        ...
        <TouchableOpacity
          ...
          onPress={() => this.props.navigation.navigate('MarriedOrder', {telepon:telepon, nama_lengkap:nama_lengkap, email_pribadi: email_pribadi,hargarupiah:this.state.hargarupiah })}>
