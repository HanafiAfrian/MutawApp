...
export default class TotalTagihan extends Component {
    ...
    tampil: false,
		...
		this.url = "https://mutawif.co.id/api/muapi/muufood.php";
...
var longitude =	this.props.route.params.longitude; 
		var tempat_tujuan =	this.props.route.params.tempat_tujuan; 
...
"&longitude="+longitude+
          ...
          .then((response)=>response.json())
          .then((json)=>{
			 this.props.navigation.navigate('CariMitraMUFood', {	
...
"&longitude="+longitude+
          ...
          .then((json)=>{
			   ...
			   this.props.navigation.navigate('CariMitraMUFoodBri', {	
...
"&longitude="+longitude+
          ...
          .then((json)=>{
			   ...
			   this.props.navigation.navigate('CariMitraMUFoodCod', {	
