...
export default class Diproses extends Component {
  constructor(props) {
    ...
    this.url = 'https://mutawif.co.id/api/muapi/selesai.php';
  }
  componentDidMount() {
    this.ambilListData();
	  this.ambilListData1();
...
this.ambilListData3();
  ...
  async ambilListData() {
    ...
    await fetch(this.url + '/?op=ambildata&telepon=' + nama_lengkap)
      ...
      .then(json => {
		  	   this.setState({jumlahselesai:json.data.result[0].jumlahselesai});
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <View style={{borderRadius: 50,
                ...
                marginBottom: 5,
                marginTop: 20}}>
             <Text style={{color: 'gray'}}>Diproses</Text>
            </View>
			  <View>
          ...
          <TouchableOpacity
            ...
            <View style={{borderRadius: 50,
                ...
                marginBottom: 5,
                marginTop: 20}}>
               <Text style={{color: 'gray'}}>Dikirim</Text>
            </View>
			 <View>
...
color: 'gray',
                      ...
                      <View
                        ...
                        {/* <Text
                          ...
                          Bayar Sebelum 29-12-2022 11:26
                        </Text> */}
                       
                      </View>
					   <TouchableOpacity
                                           onPress={() =>
                            this.props.navigation.navigate('Pembayaranselesai',{
