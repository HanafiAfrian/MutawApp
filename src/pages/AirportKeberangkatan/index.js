...
export default class AirportKeberangkatan extends Component {
 constructor(props) {
    super(props);
              ...
              <View
                ...
                <View>
                  ...
                  <Text
                    ...
                    <Text style={{color: 'white'}}> Keberangkatan</Text>
...
value = { this.state.no_hpbus }
    ...
    <View
      ...
      <View style={{marginLeft: 60}}>
        <Text style={{fontWeight: 'bold', fontSize: 16, color :'gray'}}>No.Hp Bus</Text>
        ...
        marginLeft: 20,
                      ...
                      <View
                        ...
                        <TouchableOpacity
                          ...
                          onPress={() =>
                            this.props.navigation.navigate('TotalTagihanairportkeberangkatan', {
...
totalreal: totalreal, 
            ...
            <Modal
              ...
              visible={this.state.show1}>
			   <WebView
   source={{ uri: 'https://mutawif.co.id/api/daftarb2b/uploaddokumen.php?jenis=Keberangkatan' }}
 ...
 />
              ...
              visible={this.state.show2}>
			   <WebView
   source={{ uri: 'https://mutawif.co.id/api/daftarb2b/uploaddokumen.php?jenis=FotoKoperKeberangkatan' }}
   style={styles.webViewStyle}
   javaScriptEnabled={true}
   domStorageEnabled={true}
   onLoadStart={() => this.showLoader()}
