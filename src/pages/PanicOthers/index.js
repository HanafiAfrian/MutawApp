...
export default class CategoryScreen extends Component {
 ...
 userLocation :{
   ...
   this.url = 'https://mutawif.co.id/api/muapi/panic.php';
     this.url1 = 'https://mutawif.co.id/api/muapi/panicutkgroup.php';
	 }
...
async onValueChangeCat1(value) {
 ...
 var nama = this.props.route.params.nama;
   var jenis = 	'Bantu Teman';
		 ...
		 .then(responseJson => {
 alert('Panic!! Informasi Akan dikirim Kepada Leader dan Group Travel anda');
	 ...
	 <View>
        ...
        <View
          style={{
           ...
           <TouchableOpacity onPress={() => this.props.navigation.navigate('Panic',{telepon:telepon, nama_lengkap:nama_lengkap})}>
            <Text
              style={{
                marginBottom: 10,
                fontWeight: 'bold',
          ...
          <TouchableOpacity onPress={() => this.props.navigation.navigate('PanicOthers',{telepon:telepon, nama_lengkap:nama_lengkap})}>
            <Text
              style={{
                marginBottom: 10,
                fontWeight: 'bold',
		 ...
		 <View>
            <Modal
              ...
              visible={this.state.show1}>
			   <WebView
   source={{ uri: 'https://mutawif.co.id/api/daftarb2b/uploadpanic.php?jenis=Bantu teman' }}
