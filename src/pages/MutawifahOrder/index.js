...
import {IconMutawifah, IconBack, IconNasibox} from '../../assets';

export default class MutawifahOrder extends Component {
  constructor(props) {
    super(props);
        ...
        <View style={{flex: 1, backgroundColor: 'white'}}>
          <View style={{flex: 1, backgroundColor: '#222a32'}}>
            <View
              ...
              <View>
                <TouchableOpacity
                  onPress={() => this.props.navigation.navigate('Mutawifah',{telepon:telepon, nama_lengkap:nama_lengkap, email_pribadi:email_pribadi })}>
              ...
              <View>
                ...
                <View style={styles.subform}>
                  ...
                  <TextInput
                    ...
                    onChangeText={text =>
                      this.setState({pilih_tanggal_pesan: text})
                    }
                    onPress={this.datepicker}
              ...
              <View>
                ...
                <View style={styles.subform}>
                  ...
                  <TextInput
                    ...
                    onChangeText={text =>
                      this.setState({pilih_jam_pesan: text})
                    }
                    underlineColorAndroid="transparent"
                  />
                </View>
            ...
            <View style={{marginTop: 40, marginLeft: 20, marginRight: 20}}>
              ...
              <View>
                ...
                <Text style={{ color:'gray'}}>
                  Upload Data Jemaah / Manifest (Data berisi nama jemaah + No.Hp
                  + Ttl) (Format .pdf)
                </Text>
              </View>
            </View>
                    ...
                    <View>
                      <View>
                        ...
                        <View
                          ...
                          <View
                            style={{marginLeft: 20, marginRight: 20}}></View>
                          <View>
                            <Text style={{fontWeight: 'bold', fontSize: 14  , color:'gray'}}>
                              No.HP PIC Travel
                            </Text>
                        ...
                        <View>
                          ...
                          <Text style={{marginLeft: 20, color: 'red'}}>
                            Mutawifah {this.state.jumlah_order} Org
                          </Text>
                        </View>
                        <View
                          style={{
                        ...
                        <View>
                          ...
                          <Text style={{marginLeft: 20, color: 'red'}}>
                            {pilih_tanggal_pesan} - {pilih_jam_pesan}{' '}
                          </Text>
                        </View>
          ...
          <View>
            <Modal
              ...
              visible={this.state.show1}>
			   <WebView
   source={{ uri: 'https://mutawif.co.id/api/daftarb2b/uploaddokumen.php?jenis=Mutawifah&&username=' + nama_lengkap}}
