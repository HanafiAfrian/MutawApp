...
this.url = "https://mutawif.co.id/api/muapi/rate.php";
  }
        ...
        <ScrollView>
          <View style={{flex: 1, backgroundColor: 'white'}}>
            ...
            <View style={{flex: 1}}>
              ...
              />
              <Text style={styles.pujian}>{this.state.starCount}</Text>
              <Text>Berikan Penilaian Anda Terhadap Aplikasi Mitra Kami</Text>
            </View>
			   <TouchableOpacity
