...
import {ajwa, IconBack, IconNasibox} from '../../assets';

export default class MufoodLayanandates extends Component {
  constructor(props) {
    super(props);
    this.state = {
...
Ajwa</Text>
          ...
          <View style={{
            ...
            <Text style={{color: 'white'}}>Kurma ajwa kualitas terbaik, asli dari
madinah, kurma ajwa memiliki tekstur
yang kenyal, rasa yang tidak terlalu manis
dan tidak melekat dimulut</Text>
        ...
        <TouchableOpacity
          ...
          onPress={() => this.props.navigation.navigate('MufoodOrder',{resto:'Restoran Dates', harga:this.state.harga,telepon:telepon, nama_lengkap:nama_lengkap, email_pribadi: email_pribadi , hargarupiah:this.state.hargarupiah })}>
