...
import {IconSim} from '../../assets';

export default class SimcardOrder extends Component {
constructor(props) {
    super(props);
...
const rupiah = 'Rp. ' + convert.join('.').split('').reverse().join('')
        ...
        <View style={{flex: 1, backgroundColor: 'white'}}>
          <View style={{flex: 1, backgroundColor: '#222a32'}}>
            <View
              ...
              <View>
                <TouchableOpacity
               onPress={() => this.props.navigation.navigate('Simcard',{telepon:telepon, nama_lengkap:nama_lengkap, email_pribadi:email_pribadi } )}>
              ...
              <View>
                <Image source={IconSim} style={{alignSelf: 'center'}} />
                <Text
                  style={{color: 'white', fontSize: 22, fontWeight: 'bold'}}>
                  Sim 
                  <Text style={{color: '#c19737'}}> Card</Text>
                </Text>
              </View>
              <View>
 ...
 onChangeText = {(text) => this.setState({pilih_jam_pesan: text })}
            ...
            <View style={styles.searchSection}>
              ...
              <View>
                <View>
                  <Text style={styles.subformtext}>Quantity (Pcs)</Text>
                </View>
                <View style={styles.subform}>
                  <FontAwesome5
                    size={16}
        ...
        marginLeft: 20,
                    ...
                    <View
                      ...
                      <TouchableOpacity
                        ...
                        onPress={() =>
                          this.props.navigation.navigate('TotalTagihansimcard'
						  , {
