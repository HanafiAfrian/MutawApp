    ...
    return (
      <View style={{backgroundColor: 'white', flex: 1}}>
        ...
        <View style={styles.welcomebg}>
          ...
          <Text style={styles.welcome}  onPress={() => this.props.navigation.navigate('FrmLoginFirsthaji')}>Daftar</Text>
        </View>
        ...
        <View style={styles.container}>
          ...
          <TouchableOpacity
            ...
            onPress={() => this.props.navigation.navigate('FrmDaftarHaji')}>
            <Text style={styles.bnttext}>Ketua Kloter</Text>
          </TouchableOpacity>
          <View
            style={{
              marginVertical: 20,
          ...
          <TouchableOpacity
            style={styles.roundButton1}
            onPress={() => this.props.navigation.navigate('FrmDaftarHajiPribadi')}>
