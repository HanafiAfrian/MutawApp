...
import {barnies, IconBack, IconNasibox} from '../../assets';

export default class MufoodLayananbarnies extends Component {
 constructor(props) {
    super(props);
    this.state = {
  ...
  this.url = "https://mutawif.co.id/api/muapi/muufood_barnies.php";
    }
componentDidMount()  {
  ...
  render() {
    ...
    return (
      <ScrollView style={{flex: 1, backgroundColor: '#222a32'}}>
        ...
        <View>
          <Image style={styles.imgads} source={barnies} />
        </View>
        ...
        <View
          ...
          <View style={{
            ...
            <Text style={{color: 'white'}}>Black coffee khas barnie’s dengan campuran
susu, cream dan saus caramel</Text>
        ...
        <TouchableOpacity
          ...
          onPress={() => this.props.navigation.navigate('MufoodOrder',{resto:'Restoran Barnies', harga:this.state.harga,telepon:telepon, nama_lengkap:nama_lengkap, email_pribadi: email_pribadi, hargarupiah:this.state.hargarupiah })}>
