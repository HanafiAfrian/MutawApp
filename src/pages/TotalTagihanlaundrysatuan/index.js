	  ...
	  (this.state.bni == true  && this.state.bri == false && this.state.cod == false && this.state.cc == false  )
	  {
        ...
        alert('Silakan masukkan Waktu Pesan Dan Identitas Mutawif');
          ...
          if(this.state.idEdit){
            ...
            var urlAksi = this.url+"/?op=pesansatuan";
...
"&longitude="+longitude+
          ...
          .then((response)=>response.json())
          .then((json)=>{
			 this.props.navigation.navigate('CariMitraLaundri', {	
...
"&longitude="+longitude+
          ...
          .then((json)=>{
			   ...
			   this.props.navigation.navigate('CariMitraLaundriBri', {	
...
"&longitude="+longitude+
          ...
          .then((json)=>{
			   ...
			   this.props.navigation.navigate('CariMitraLaundriCod', {	
