...
const rupiah = 'Rp. ' + convert.join('.').split('').reverse().join('')
 ...
 onChangeText = {(text) => this.setState({pilih_jam_pesan: text })}
            ...
            <View style={{margin: 20}}>
              ...
              <Text style={{marginLeft: 10,color:'gray'}}>Upload Data Room List (Format .pdf)</Text>
            </View>
            <TouchableOpacity
		   ...
		   <View>
            <Modal
              ...
              visible={this.state.show1}>
			   <WebView
   source={{ uri: 'https://mutawif.co.id/api/daftarb2b/uploaddokumen.php?jenis=CHECKIN&&username=' + nama_lengkap }}
