...
const rupiah = 'Rp. ' + convert.join('.').split('').reverse().join('')
	console.log(rupiah)  
	  	  ...
	  	  if (this.state.jumlah_order < 30)
	  {
		  alert('Minimal Jumlah 30 Orang');  
...
const rupiah = 'Rp. ' + convert.join('.').split('').reverse().join('')
              ...
              <View>
                ...
                <Text
                  style={{color: 'white', fontSize: 22, fontWeight: 'bold'}}>
                    <Text style={{color: 'white'}}>Badar + Jabal Malaikah</Text>
                </Text>
              </View>
              <View>
 ...
 value = {this.state.jumlah_order}
    ...
    <View>
      ...
      <Text style={{marginLeft: 20, color: 'red'}}>Ziarah Badar + Jabal Malaikah</Text>
    </View>
    <View
      style={{
        borderBottomWidth: 1,
