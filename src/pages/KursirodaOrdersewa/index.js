...
var longitude =	this.props.route.params.longitude; 
  ...
  var totalreal = this.state.jumlah_order * this.state.hargajns3;
	  var totalrupiah = this.state.jumlah_order * this.state.hargarupiahjns3;
	  
	  	  const numb = this.state.jumlah_order *hargarupiahjns3 ;
...
const rupiah = 'Rp. ' + convert.join('.').split('').reverse().join('')
        ...
        <View style={{flex: 1, backgroundColor: 'white'}}>
          <View style={{flex: 1, backgroundColor: '#222a32'}}>
            <View
              ...
              <View>
                <TouchableOpacity
                  onPress={() => this.props.navigation.navigate('KursirodaOrder',{telepon:telepon, nama_lengkap:nama_lengkap, email_pribadi:email_pribadi , hargarupiah:hargarupiah,  hargarupiahjns2:hargarupiahjns2 ,hargarupiahjns3:hargarupiahjns3})}>
 ...
 value = {this.state.jumlah_order}
            ...
            <View style={styles.searchSection}>
              <View>
                <View>
                  <Text style={styles.subformtext}>Lokasi Penjemputan</Text>
                </View>
                <View style={styles.subform}>
                  <FontAwesome5
                    size={16}
                  ...
                  <TextInput
                    ...
                    placeholder="Lokasi Penjemputan"
					 placeholderTextColor="gray"
         value = { this.state.tempat_pilih_penjemputan }
                    onChangeText = {(text) => this.setState({tempat_pilih_penjemputan: text })}
                    underlineColorAndroid="transparent"
                  />
                </View>
              </View>
   ...
   Nomor Kamar
    ...
    <View>
      ...
      <Text style={{marginLeft: 20, color: 'red'}}>
       {this.state.tempat_pilih_penjemputan}
      </Text>
      <View
        style={{
          borderBottomWidth: 1,
