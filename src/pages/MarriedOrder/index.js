...
import {IconMarried, IconBack, IconNasibox} from '../../assets';

export default class MarriedOrder extends Component {
  constructor(props) {
    super(props);
...
const rupiah = 'Rp. ' + convert.join('.').split('').reverse().join('')
        ...
        <View style={{flex: 1, backgroundColor: 'white'}}>
          <View style={{flex: 1, backgroundColor: '#222a32'}}>
            <View
              ...
              <View>
                <TouchableOpacity
                   onPress={() => this.props.navigation.navigate('Married',{telepon:telepon, nama_lengkap:nama_lengkap, email_pribadi:email_pribadi } )}>
              ...
              <View>
                <Image source={IconMarried} style={{alignSelf: 'center'}} />
                <Text
          ...
          <View style={styles.container}>
            ...
            <View style={styles.searchSection}>
              <View>
                <View>
                  <Text style={styles.subformtext}>Pilih Tanggal Meeting</Text>
                </View>
 ...
 onChangeText = {(text) => this.setState({pilih_jam_pesan: text })}
    ...
    <View>
      ...
      <Text style={{marginLeft: 20, color: 'red'}}>{this.state.nohp_mutawif}</Text>
    </View>
    <View
      style={{
        borderBottomWidth: 1,
        ...
        marginLeft: 20,
                    ...
                    <View
                      ...
                      <TouchableOpacity
                        ...
                        onPress={() =>
                                           this.props.navigation.navigate('TotalTagihanmerried', {
