...
rupiahharga :'',
  ...
  var totalreal = this.state.jumlah_order * this.state.hargarealjns2;
...
const rupiah = 'Rp. ' + convert.join('.').split('').reverse().join('')
 ...
 value = {this.state.jumlah_order}
    ...
    <View>
      ...
      <Text style={{marginLeft: 20, color: 'red', color:'red', fontSize: 14}}> Badal Umrah</Text>
    </View>
    <View
      style={{
        borderBottomWidth: 1,
...
totalreal: totalreal, 
    ...
    <View>
      ...
      <Text style={{marginLeft: 20, color: 'red'}}> Badal Umrah</Text>
    </View>
    <View
      style={{
        borderBottomWidth: 1,
		 ...
		 <View>
            <Modal
              ...
              visible={this.state.show2}>
			   <WebView
   source={{ uri: 'https://mutawif.co.id/api/daftarb2b/uploaddokumen.php?jenis=UmrahKTP&&username=' + nama_lengkap  }}
 ...
 />
            ...
            <Modal
              ...
              visible={this.state.show3}>
			   <WebView
   source={{ uri: 'https://mutawif.co.id/api/daftarb2b/uploaddokumen.php?jenis=Umrahfoto&&username=' + nama_lengkap  }}
   style={styles.webViewStyle}
   javaScriptEnabled={true}
   domStorageEnabled={true}
   onLoadStart={() => this.showLoader()}
