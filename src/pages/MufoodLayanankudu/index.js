...
import {kudu, IconBack, IconNasibox} from '../../assets';

export default class MufoodLayanankudu extends Component {
 constructor(props) {
    super(props);
    this.state = {
  ...
  this.url = "https://mutawif.co.id/api/muapi/muufood_kudu.php";
    }
	componentDidMount()  {
  ...
  render() {
    ...
    return (
      <ScrollView style={{flex: 1, backgroundColor: '#222a32'}}>
        ...
        <View>
          <Image style={styles.imgads} source={kudu} />
        </View>
          ...
          <View
            ...
            <View>
              <Text
               ...
               Chicken 
<Text style={{color: 'orange'}}> Combo</Text>
              </Text>
          ...
          <View style={{
            ...
            <Text style={{color: 'white'}}>Potongan ayam panggang ditemani dengan
campuran sayuran segar semua ditumpuk di
dalam roti tawar kudu, disajikan dengan kentang
goreng dan minuman ringan</Text>
