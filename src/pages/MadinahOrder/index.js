...
export default class MadinahOrder extends Component {
  constructor(props) {
    super(props);
            ...
            <View
              ...
              <View>
                ...
                <Text
                  ...
                  <Text style={{color: 'white'}}>Ziarah Kota Madinah</Text>
                </Text>
              </View>
              <View>
                <Text>/</Text>
          ...
          <View style={styles.container}>
            ...
            <View
              ...
              <View style={{display: 'flex', flexDirection: 'row'}}>
                <RadioButton
                  color={'#0d7883'}
                  selected={this.state.jma}
                  onPress={() => this.jmaPressed()}
                />
              ...
              <View
                ...
                <RadioButton
                  color={'#0d7883'}
                  selected={this.state.akm}
                  onPress={() => this.akmPressed()}
                />
                <Text style={{marginTop: 2, marginLeft: 2}}>
                  Al Ula + Khaibar + Madain Shaleh
                </Text>
              </View>
              <View
                style={{
                ...
                <RadioButton
                  color={'#0d7883'}
                  selected={this.state.bjm}
                  onPress={() => this.bjmPressed()}
                />
                <Text style={{marginTop: 2, marginLeft: 2}}>
                  Bada + Jabal Malaikah
                </Text>
