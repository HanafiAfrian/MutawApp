...
import {IconDam} from '../../assets';
export default class HajaraswadOrder extends Component {
 constructor(props) {
    super(props);
        ...
        <View style={{flex: 1, backgroundColor: 'white'}}>
          <View style={{flex: 1, backgroundColor: '#222a32'}}>
            <View
              ...
              <View>
                <TouchableOpacity
                       onPress={() => this.props.navigation.navigate('Damqurban',{telepon:telepon, nama_lengkap:nama_lengkap, email_pribadi:email_pribadi, hargarupiah:hargarupiah } )}>
              ...
              <View>
                <Image source={IconDam} style={{alignSelf: 'center'}} />
                <Text
                  style={{color: 'white', fontSize: 22, fontWeight: 'bold'}}>
                  Dam &<Text style={{color: '#c19737'}}> Qurban {this.state.hargarupiah}</Text>
                </Text>
              </View>
              <View>
        ...
        marginRight: 20,
                    ...
                    <View
                      ...
                      <TouchableOpacity
                        ...
                        onPress={() =>
                          this.props.navigation.navigate('TotalTagihandamqurban', {
